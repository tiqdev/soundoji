...
class _HomePageState extends State<HomePage> {
  ...
  List<SoundojiObj> soundojis = [
    SoundojiObj(
        ...
        iconPath: 'assets/images/slap.svg'),
    SoundojiObj(
        category: 'Funny',
        soundPath: 'sounds/pew.wav',
        iconPath: 'assets/images/pew.svg'),
    SoundojiObj(
        category: 'Funny',
        soundPath: 'sounds/flop.mp3',
        iconPath: 'assets/images/flop.svg'),
    SoundojiObj(
        category: 'Funny',
        soundPath: 'sounds/mp5.wav',
        iconPath: 'assets/images/mp5.svg'),
    SoundojiObj(
        category: 'Funny',
    ...
    SoundojiObj(
        ...
        iconPath: 'assets/images/baby.svg'),
    SoundojiObj(
        category: 'Funny',
        soundPath: 'sounds/kiss.mp3',
        iconPath: 'assets/images/kiss.svg'),
    SoundojiObj(
        category: 'Animals',
        soundPath: 'sounds/cow.mp3',
        iconPath: 'assets/images/cow.svg'),
    SoundojiObj(
        category: 'Animals',
        soundPath: 'sounds/dog.mp3',
        iconPath: 'assets/images/dog.svg'),
    SoundojiObj(
        category: 'Animals',
    ...
    SoundojiObj(
        ...
        iconPath: 'assets/images/sheep.svg'),
    SoundojiObj(
        category: 'Animals',
        soundPath: 'sounds/horse.mp3',
        iconPath: 'assets/images/horse.svg'),
    SoundojiObj(
        category: 'Animals',
        soundPath: 'sounds/bird.mp3',
        iconPath: 'assets/images/bird.svg'),
    SoundojiObj(
        category: 'Animals',
        soundPath: 'sounds/lion.mp3',
        iconPath: 'assets/images/lion.svg'),
    SoundojiObj(
        category: 'Vehicles',
